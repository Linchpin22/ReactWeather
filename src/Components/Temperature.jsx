  ...
  return (
    <>
      <div className="flex align-middle justify-center">
        <input
          type="text"
          className="bg-zinc-600 border border-zinc-500 rounded-lg text-slate-200 placeholder-slate-200 text-md focus:border-zinc-400 block w-60 p-2 focus:outline-none"
